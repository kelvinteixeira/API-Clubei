...
exports.default = {
    create: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, id_categoria, categoria, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, id_categoria = _a.id_categoria, categoria = _a.categoria;
                        data = { id_categoria: id_categoria, categoria: categoria };
                        return [4 /*yield*/, (0, connection_1.default)('categorias').insert(data)];
                    case 1:
                        _b.sent();
    ...
    list: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, connection_1.default)('categorias').orderBy('id_categoria')];
                    case 1:
                        categorias = _a.sent();
                        return [2 /*return*/, res.status(200).json(categorias)];
                }
            });
        });
    },
    update: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id_categoria, categoria, data, categorias;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id_categoria = req.params.id_categoria;
                        ...
                        return [4 /*yield*/, (0, connection_1.default)('categorias').update(data).where({ id_categoria: id_categoria })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, connection_1.default)('categorias').where({ id_categoria: id_categoria })];
                    case 2:
                        categorias = _a.sent();
